...
const CourseScreen = () => {
  ...
  const changeLesson = (lesson: React.SetStateAction<{ id: number; title: string; content: string; subTopics: ({ title: string; content: string; code_output: { code: string[]; fileName: string; language: string; size: number; }[]; } | { title: string; content: string; code_output: { code: string[]; fileName: string; language: string; }[]; } | { title: string; content: string; code_output?: undefined; })[]; example: string; }>) => {
